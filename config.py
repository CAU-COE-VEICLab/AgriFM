...
# Resnet
_C.MODEL.RESNET = CN()
_C.MODEL.RESNET.LAYERS = [3, 4, 23, 3]
...
# mobilevit
_C.MODEL.MOBILEVIT = CN()
_C.MODEL.MOBILEVIT.TYPE = 's'  # s xs xxs

# pvt
_C.MODEL.PVT = CN()
_C.MODEL.PVT.PATCH_SIZE = 4
_C.MODEL.PVT.IN_CHANS = 3
_C.MODEL.PVT.EMBED_DIMS = [32, 64, 160, 256]
...
_C.MODEL.PVT.ATTN_DROP_RATE = 0.
_C.MODEL.PVT.DROP_PATH_RATE = 0.
_C.MODEL.PVT.DEPTHS = [2, 2, 2, 2]
...
_C.MODEL.CONVNEXT.IN_CHANS = 3
_C.MODEL.CONVNEXT.DIMS = [96, 192, 384, 768]
_C.MODEL.CONVNEXT.QKV_BIAS = True
